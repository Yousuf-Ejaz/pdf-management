...
function Navbar() {
  ...
  <nav
    className="relative  w-full mx-auto px-16  sm:flex sm:items-center sm:justify-between "
    aria-label="Global"
  >
    <div className="flex items-center justify-between">
      <a
        ...
        aria-label="Brand"
      >
        PDF MANAGEMENT AND COLLABORATION TOOL
      </a>
    ...
    >
      <div className="flex flex-col gap-y-4 gap-x-0 mt-5 sm:flex-row sm:items-center sm:justify-end sm:gap-y-0 sm:gap-x-7 sm:mt-0 sm:pl-7">
        <Link
          className="font-semibold text-green-950 sm:py-6  "
          to="/dashboard"
          aria-current="page"
        >
          DASHBOARD
        ...
        <a
          className="flex items-center gap-x-2 font-medium text-green-950 sm:border-l sm:border-green-900 sm:my-6 sm:pl-6"
          href="#"
        >
          <svg
            className="w-4 h-4"
